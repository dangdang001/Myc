...
res1=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=1,theta=10)
res2=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=2,theta=10)
res3=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=3,theta=10)
res4=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=4,theta=10)
res5=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=5,theta=10)
res6=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=6,theta=10)
res7=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=7,theta=10)
res8=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=8,theta=10)
res9=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=9,theta=10)
res10=simu_myc_effect(n=1000,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=10,theta=10)
