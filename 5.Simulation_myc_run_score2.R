...
m=10 # number of total myc-target genes
...
res1=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=1)
res2=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=2)
res3=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=3)
res4=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=4)
res5=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=5)
res6=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=6)
res7=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=7)
res8=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=8)
res9=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=9)
res10=simu_myc_effect(n=1000,m=15,K=10,lambda=0.01,alpha=0.1,nb_mean=5,nb_size=1,coef_myc=10)
